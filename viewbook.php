<?php
	...
	$query = mysqli_query($mysqli,"select b.isbn, b.judul, b.tahun, pn.nama_penerbit, pg.nama_pengarang, kg.nama from buku b 
	...
	echo "<center>Data Buku Yang Berada di Site Ini</center>";
